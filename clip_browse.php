<?php
/**
 * clip_browse.php - Public clip browser with category filtering
 *
 * Allows users to browse all clips, filter by game/category,
 * and search by title. Links directly to Twitch for playback.
 *
 * Usage: clip_browse.php?login=floppyjimmie
 */
...
$perPage = 60; // Show 60 clips per page
...
if ($pdo) {
  try {
    ...
    error_log("clip_browse db error: " . $e->getMessage());
  }
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Clip Browser - <?= htmlspecialchars($login) ?></title>
  <style>
    * { box-sizing: border-box; }
    ...
    @media (max-width: 768px) {
      ...
      .clips-grid { grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 12px; }
    }
  </style>
</head>
<body>
  <div class="container">
    <header>
      ...
      <div class="header-right">
        <div class="total-count">
          <strong><?= number_format($totalCount) ?></strong> clips
    ...
    <form class="filters" method="get">
      ...
      <div class="filter-group">
        <label>Search</label>
        <input type="text" name="q" value="<?= htmlspecialchars($query) ?>" placeholder="Search clip titles...">
      </div>
